...
(async () => {
    ...
    let _saferpayLogo2 = "https://qa.saferpay.com/userscripts/timmi-ess-fusion-saferpay-logo.png";
    ...
    async function sessionHandling(){
        if (window.location.href.indexOf('ZCA_TIMESHEET') !== -1){
            $('body').append($('<img src="' + _saferpayLogo2 + '?cachebusting=' + moment(new Date()).format("YYYY-MM-DD") + '" style="width:1px;height:1px"/>'));
