...
(async () => {
    ...
    let _saferpayLogo2 = "https://github.com/draganignjic/timmi-ess-fusion/blob/master/images/saferpay-logo.png";
    ...
    function fixLayout(){
        ...
        $('#htmlb_image_1').after($('<img src="' + _saferpayLogo2 + '" style="width:1px;height:1px"/>'));
